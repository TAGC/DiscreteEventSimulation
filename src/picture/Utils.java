...
public class Utils {
     ...
     * 
     * @param location
     *            a String representing the location of the image to be loaded.
     *            This can either be a URL, or a filesystem location.
     * @return a Picture representing the image at the specified URL, or null if
     *         loading failed for any reason.
     */
    public static Picture loadImage(String locationString) {
